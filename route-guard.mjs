export const ACCESS_COOKIE_KEY = "p11_access_token";

export const INTERNAL_DOC_ROUTES = new Set([
...
export function createRouteGuardMiddleware({ supabaseUrl, supabaseAnonKey }) {
  const cache = new Map();
